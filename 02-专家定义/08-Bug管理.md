...
results = json.load(open("workspace/执行日志/regression_summary.json", encoding="utf-8"))
...
def generate_bug_daily_report(product_id: int, output_dir: str = "workspace/执行日志/报告"):
