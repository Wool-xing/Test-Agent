...
```text
□ test-executor 已输出 workspace/测试报告/{项目名}/regression_summary.json
...
send_test_report_email(
    ...
    attachments=[
        "workspace/测试报告/{项目名}/测试报告_20260510.docx",
        "workspace/测试报告/{项目名}/测试报告_20260510.pdf",
        "workspace/测试报告/{项目名}/测试摘要_20260510.pptx",
    ],
