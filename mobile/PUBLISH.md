...
|------|------|
| `VERSION` | `1.33.0` |
| `runtime/__init__.py` | `__version__ = "1.33.0"` |
| `runtime/pyproject.toml` | `version = "1.33.0"` |
| `desktop/package.json` | `"version": "1.33.0"` |
| `desktop/electron/preload.ts` | `"1.33.0"` |
| `mobile/package.json` | `"version": "1.33.0"` |
| `mobile/capacitor.config.json` | `"version": "1.33.0"` |
