...
**当前阶段**：Phase 2（V1.23.0-alpha · 16 expert + 16/32 skill production；rollout 进行中）
**版本**：V1.23.0-alpha（详见 [VERSION](VERSION) + [CHANGELOG.md](CHANGELOG.md)）
**更新日期**：2026-05-16
...
| 07 | [runtime-license](docs/charter/07-runtime-license.md) | V1.23.0-alpha 运行时层 + LICENSE / CHANGELOG / 项目当前状态 |
