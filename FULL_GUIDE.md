...
**当前阶段**：Phase 2 前期（V1.32.1 · 16 expert + 23/32 skill production + 0 rollout + 2 vision；V1.x rollout 收尾）
**版本**：V1.32.1（详见 [VERSION](VERSION) + [CHANGELOG.md](CHANGELOG.md)）
**更新日期**：2026-05-17
...
| 07 | [runtime-license](docs/charter/07-runtime-license.md) | V1.32.1 运行时层 + LICENSE / CHANGELOG / 项目当前状态 |
