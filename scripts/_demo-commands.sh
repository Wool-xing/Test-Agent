...
# 清干净(录制前)
rm -rf workspace/_demo workspace/测试报告/*.json workspace/测试用例/_smoke_out workspace/_init_smoke 2>/dev/null || true
...
# Outro · 看产物
step "产物清单"
prompt "ls workspace/测试报告/*.json"
ls workspace/测试报告/*.json 2>/dev/null
sleep 2
