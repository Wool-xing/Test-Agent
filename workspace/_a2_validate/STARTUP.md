...
> 生成于 2026-05-16 00:53:17 · Test-Agent 1.14.0-alpha
...
- `BUG_WEBHOOK_URL` (BugTracker:自定义 Webhook)
- `EMAIL_SMTP_HOST` (通知:SMTP 邮件)
- `EMAIL_SMTP_USER` (通知:SMTP 邮件)
- `EMAIL_SMTP_PASSWORD` (通知:SMTP 邮件)
- `EMAIL_TO` (通知:SMTP 邮件)
...
# 真跑(用上面配的 LLM)
tagent run "https://example.com" --mode learn
```
