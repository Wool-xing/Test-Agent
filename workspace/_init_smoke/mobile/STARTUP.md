...
> 配置:**移动 App 测试(Android/iOS)** · Linux(Ubuntu/Debian/CentOS) · LLM=claude · BugTracker=github · 通知=Slack Incoming Webhook
> 生成于 2026-05-12 04:22:27 · Test-Agent 1.12.0-alpha
...
# 真跑(用上面配的 LLM)
tagent run "/path/to/app.apk" --mode learn
```
