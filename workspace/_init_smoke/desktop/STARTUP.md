...
> 配置:**桌面应用测试** · Linux(Ubuntu/Debian/CentOS) · LLM=claude · BugTracker=github · 通知=Slack Incoming Webhook
> 生成于 2026-05-12 04:22:28 · Test-Agent 1.12.0-alpha
...
# 真跑(用上面配的 LLM)
tagent run "C:/Program Files/YourApp/YourApp.exe" --mode learn
```
