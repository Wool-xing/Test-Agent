...
def resolve(name: str) -> CommandDef | None:
    ...
    global _repl_initialized
    if not _repl_initialized:
        _init_repl_handlers()
...
# Deferred to break circular import: slash_handlers → slash_commands → slash_handlers
# Called lazily on first REPL command execution (or explicitly via _init_repl_handlers())
# ═══════════════════════════════════════════════════════════════════
