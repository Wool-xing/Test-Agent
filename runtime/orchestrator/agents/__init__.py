...
11 核心 runner(rollout 收尾,所有 LLM-driven expert 已实装):
...
- visual-tester
- system-tester
- pentest-tester (ROADMAP rollout #5 落地 — minimum viable;
  仅输出测试计划文本, 不调外部攻击工具;真执行守护已在 utils 层 env gate)
- automotive-tester (ROADMAP rollout #6 落地 — minimum viable;
  rollout 收尾;ASIL 评估 + HIL 测试 + ADAS 场景 + OTA + 合规矩阵)
