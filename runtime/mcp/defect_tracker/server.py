...
Per charter + : severity 1=P0 / 2=P1 / 3=P2 / 4=P3 一致。
"""
...
def _flywheel_get(bug_id: str) -> dict | None:
    ...
    with session_scope() as s:
        ...
        if d is None:
            return None
        # Charter : 1=P0 / 2=P1 / 3=P2 / 4=P3 (one-based; enum value "P0".."P3" is zero-based string)
...
def build_server():
    ...
    TOOLS = [
        Tool(
            name="create_bug",
            description="Create a defect. severity 1=P0 / 2=P1 / 3=P2 / 4=P3 (charter ).",
            inputSchema={
                "type": "object",
                "properties": {
                    "title": {"type": "string"},
