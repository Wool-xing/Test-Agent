...
默认配置文件: 04-配置文件/quality_gates.yaml
...
DEFAULT_CONFIG = Path(__file__).resolve().parent.parent / "04-配置文件" / "quality_gates.yaml"
...
def main() -> None:
    ...
    parser.add_argument("--config", help="YAML 配置文件路径 (默认: 04-配置文件/quality_gates.yaml)")
