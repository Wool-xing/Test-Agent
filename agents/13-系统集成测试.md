...
| 文件 | 用途 |
|------|------|
| `workspace/测试报告/iot-logs/*.log` | SSH/串口/MQTT 日志 |
| `workspace/测试报告/media-frames/*.png` | 视频抽帧对比 |
| `workspace/测试报告/tracing/*.json` | Jaeger trace 数据 |
| `workspace/测试报告/mq-logs/*.log` | MQ 投递/消费日志 |
