...
| 文件 | 用途 |
|------|------|
| `workspace/测试报告/screenshots/desktop/*.png` | 桌面失败截图 |
| `workspace/测试报告/win-event-log/*.evtx` | Windows Event 日志 |
| `workspace/测试报告/mac-console/*.log` | macOS Console 日志 |
| `workspace/测试报告/desktop-perf/*.json` | psutil 进程性能 |
